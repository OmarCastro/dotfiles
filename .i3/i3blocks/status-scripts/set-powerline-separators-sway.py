...
pango_separator_text="<span font_desc=\""+separator_font_descriptions+"\">\uE0B2</span><span font_desc=\""+separator_font_space+"\"> </span>"
pango_same_bg_separator_text="<span font_desc=\""+separator_font_descriptions+"\"></span><span font_desc=\""+separator_font_space+"\"> </span>"
...
def remove_top_and_bottom_1px_border(block):
    if remove_1px_and_top_bottom_border == True:
        if 'background' in block:
            block['border'] = block['background']
        elif 'color' in block:
            block['border'] = block['color']
...
for line in sys.stdin:
    try:
        ...
        if 'background' in obj[0]:
            ...
            remove_top_and_bottom_1px_border(result[0])
